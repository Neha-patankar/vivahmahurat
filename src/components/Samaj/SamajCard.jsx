          ...
          {filteredCommunities.length > 0 ? (
            filteredCommunities.map((community, index) => (
              ...
              >
                <div className="text-center">
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-full mb-3 bg-gradient-to-r ${community.gradient} shadow-md group-hover:shadow-lg transition-all`}
                  >
